    ...
    <footer className="bg-amber-700 w-full h-auto  mt-16 text-slate-50 flex flex-col">
      <div className="w-full h-auto flex flex-col md:flex-row">
        <div className="w-full md:w-[20%] h-auto p-6">
          <h3 className="font-fvolkhov font-bold underline decoration-slate-50 decoration-wavy underline-offset-8">
            Navegacion
          </h3>
      ...
      <div className="w-full h-auto">
        <h3 className="text-center p-2">
          {' '}
          Tzuzul Bootcamp 2022 &copy; Desarrollada por Gonzalo P., Christian C. y Nahum C.{' '}
        </h3>
      </div>
    </footer>
  )
