...
const CartProduct = ({ product }) => {
    ...
    return (
        <div className="h-24 flex items-center justify-between bg-white rounded-md my-3 border-solid border-l-8 border-l-amber-500 border-b-black border-b-opacity-10 shadow-md shadow-[0_3px_6px_rgb(0,0,0,0.1)]">
            <div className='h-auto w-7/12 flex items-center ml-5'>
                <Image className='rounded-md' src={product.img} width={50} height={75}/>
                <h1 className="font-fvolkhov font-normal text-xl ml-5">{product.description}</h1>
            </div>
